module robot_rental_platform::rental_escrow {
    ...
    public fun force_end_rental(
        ...
        // NOTE: force_end_rental takes robot_id per spec but we need rental_id for table lookup.
    ...
    public(package) fun has_active_rental_by_addr(
        ...
        // NOTE: no efficient way to check "has active rental by address" without indexer
        let _ = escrow;
        true
    }
